...
exports.getAllPosts = handleError(
  async (req, res, next) => {
...
// Get post by id
exports.getPostById = handleError(
  async (req, res, next) => {
    const { id } = req.params
    ...
    if (!post) {
      return next(
        new AppError(404, 'No post was found with given ID')
      )
    }
...
exports.createPost = handleError(async (req, res, next) => {
  ...
  if (!title || !content || !userId) {
    return next(
      new AppError(
        400,
        'Must provide a title, content and userID'
      )
    )
  }
...
// Update post (put)
exports.updatePostPut = handleError(
  async (req, res, next) => {
    const { id } = req.params
...
// Update post (patch)
exports.updatePostPatch = handleError(
  async (req, res, next) => {
    const { id } = req.params
...
// Delete post
exports.deletePost = handleError(async (req, res, next) => {
  const { id } = req.params
